...
export function JoinRoom(){
    return (
        <div className="w-[37vw] border border-gray-500 p-5 rounded-xl font-mono">
            ...
            <button className="text-lg w-full border border-white mt-4 mb-4 p-2 rounded-md bg-white text-stone-950 font-bold cursor-pointer hover:bg-stone-200">Create new Room</button>
